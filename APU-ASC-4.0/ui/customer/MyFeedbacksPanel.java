...
public class MyFeedbacksPanel extends JPanel {
    ...
    private final MyAppointmentsPanel appointmentsPanel;
    private final AppointmentManager appointmentManager;

    public MyFeedbacksPanel(String userID, Runnable onNavigateToAppointments, MyAppointmentsPanel appointmentsPanel) {
    ...
    private void initializeUI() {
        ...
        JLabel titleLabel = new JLabel("My Feedbacks");
        ...
        feedbackTable.getTableHeader().setBackground(StyleConfig.GREY);
    ...
    private void loadFeedbacks() {
        ...
        cachedFeedbacks = feedbackManager.getFeedbacksByUser(customerID);
        
        for (Feedback fb : cachedFeedbacks) {
            Appointment appt = appointmentManager.getAppointmentById(fb.getAppointmentId());
            String technicianID = (appt != null) ? appt.getTechnicianID() : "Unknown Technician";
    ...
    private void openDetailsDialog() {
        ...
        scrollPane.setViewportView(reloadConversationFeedback(apptID, customerID, PANEL_BG, scrollPane));
        ...
        btnRow.add(makeButton("View Appointment Details", e -> {
            ...
            appointmentsPanel.openDialog(apptID);
        }));
    ...
    private JButton makeButton(String text, java.awt.event.ActionListener action) {
        ...
        btn.setBackground(StyleConfig.BLUE);
