...
public class CustomerDashboard extends JPanel {
    ...
    public CustomerDashboard(User currentUser) {
        ...
        this.customerId = currentUser.getUserID();
        initializeUI();
    }
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel welcomeLabel = new JLabel("Customer Dashboard - " + customerId);
    ...
    private JPanel createContentPanel() {
        ...
        JButton myAppointmentsButton = createModuleButton("My Appointments", "", 200, 200);
        myAppointmentsButton.addActionListener(e -> showMyAppointmentsModule());
        contentPanel.add(myAppointmentsButton, gbc);

        JButton myFeedbacksButton = createModuleButton("My Feedbacks", "", 200, 200);
        myFeedbacksButton.addActionListener(e -> showMyFeedbacksModule());
        gbc.gridx = 1;
        contentPanel.add(myFeedbacksButton, gbc);
        ...
        JButton historyButton = createModuleButton("Payment History", "", 200, 200);
        historyButton.addActionListener(e -> showHistoryModule());
        gbc.gridy = 3;
    ...
    private void showMyAppointmentsModule() {
        myAppointmentsPanel = new MyAppointmentsPanel(customerId);
        showModule(new MyAppointmentsPanel(customerId));
    }

    private void showMyFeedbacksModule() {
        if (myAppointmentsPanel == null) {
            myAppointmentsPanel = new MyAppointmentsPanel(customerId);
        }
        
        showModule(new MyFeedbacksPanel(customerId, this::showMyAppointmentsModule, myAppointmentsPanel));
    }

    private void showEditProfile() {
        showModule(new ProfilePanel(currentUser, this::showDashboard));
    }
    ...
    private void showHistoryModule() {
        ...
        HistoryPanel panel = new HistoryPanel(customerId);
